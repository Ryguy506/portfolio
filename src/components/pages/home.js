...
export default function Home() {
  return (
    <div className=''>
      <div id='about' className='container rounded shadow-lg'>
        <div className="row">
